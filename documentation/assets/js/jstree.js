...
!(function (a) {
  ...
  if (!a.jstree) {
    ...
    (a.jstree.plugins.dnd = function (b, c) {
      ...
      (a.jstree.defaults.search = { ajax: !1, mPay: !1, case_sensitive: !1, show_only_matches: !1, show_only_matches_children: !1, close_opened_onclear: !0, search_leaves_only: !1, search_callback: !1 }),
          ...
          (this.search = function (c, d, e, f, g, h) {
            ...
            if (
              (g || ((this._data.search.str = c), (this._data.search.dom = a()), (this._data.search.res = []), (this._data.search.opn = []), (this._data.search.som = e), (this._data.search.smc = h)),
                (l = new a.vakata.search(c, !0, { caseSensitive: i.case_sensitive, mPay: i.mPay })),
      ...
      (function (a) {
        (a.vakata.search = function (b, c, d) {
          (d = d || {}), (d = a.extend({}, a.vakata.search.defaults, d)), d.mPay !== !1 && (d.mPay = !0), (b = d.caseSensitive ? b : b.toLowerCase());
          var e = d.location,
            f = d.distance,
            g = d.threshold,
            h = b.length,
          ...
          return (
            ...
            (l = function (a) {
              ...
              if (!d.mPay) return { isMatch: !1, score: 1 };
              var c,
                f,
                l = a.length,
                m = g,
          ...
          (a.vakata.search.defaults = { location: 0, distance: 100, threshold: 0.6, mPay: !1, caseSensitive: !1 });
      })(a),
